...
/*    
         public function callback(Request $req){
                ...
                return redirect()->route('profile_payment_client',$payment_id);
         }
         
*/         
             
         public function profile($affairs=''){
...
/*
                ...
                //->orwhereIn('to_user_id', [$offer->user_id,$user->id])
                ->groupby('id')
                ->get();
*/
                ...
                //$offers[$key]->messages_count=$messages->count();
                //$offers[$key]->messages_count='';
/*                echo '<p>'.$offer->id,$offer->user_id,$user->id.'</p>';
...
*/ 
             ...
             return view('profile.client.profile',['user'=>$user,'offers' => $offers]);
         ...
         public function add_money(){
             return view('profile.client.add_money');
         }
         ...
         public function add_money_submit(Request $req){
            ...
            if($summ>0){
                ...
                return redirect()->route('profile_payment_client',$id);
            
            }else{
                
                return redirect()->route('profile_add_money_client');
            ...
            ->first();
                ...
                if(isset($payment)){
                    ...
                    if($payment->operationId){
                        ...
                        return view('profile.client.payment',['payment'=>$payment,'operationUrl'=>$operationUrl]);
...
//return view('admin.offers', ['offers' => $offers]); 
           ...
           foreach($offers as $key=>$offer){
            ...
            return view('profile.client.messages', ['offers' => $offers]);        
         ...
         public function messages_offer($id,$id_m){
           ...
           foreach($offers as $key=>$offer){
            ...
            if($messages->count()){
                ...
                return view('profile.client.messages', ['offers' => $offers,'messages' => $messages,'id'=>$id,'id_m'=>$id_m,'user_id'=>$user->id]);        
...
*/            
         ...
         public function rental_request(){
            return view('profile.client.rental_request');
         }
         ...
         public function offers(){
             return view('profile.client.offers');
         }
      ...
      //   }
         ...
         public function employers(){
             ...
             return view('profile.client.employers',['employers' => $employers]);
         }

         public function values(){
             return view('profile.client.values');
         }
         ...
         public function users(){
             ...
             return view('profile.client.users',['users' => $users,'roles' => $roles]);
         }
         ...
         public function blog(){
             ...
             return view('profile.client.blog', ['blogs' => $blog]);
...
*/                        
            ...
            //return view('profile.offers_edit', ['offer' => $Offer,'offer_images'=>$offer_images]);             
             ...
             return view('profile.client.blog_edit', ['post' => $post]);
 ...
 //           $roles = DB::table('roles')->where('id', $id)->first();    
  ...
  //           return view('profile.settings');
            ...
            return view('profile.client.settings', ['roles' => $roles]); 
         ...
         public function offers_add(Request $request){
    	    ...
    	    $token = $result['_token'];
             ...
             return view('profile.client.offers_add',['token'=>$token]);
         }
        ...
        public function offers_delete_file(Request $request)
        {
          ...
          public function edit_profile(){
             ...
             return view('profile.client.edit_profile',['user'=>$user]);
         }
 ...
 */
           ...
           return redirect()->route('profile_edit_profile_client');
          ...
          public function user_add(){
            ...
            // $user = User::find($id);
             ...
             return view('profile.client.user_add');
         }
 ...
 */
           ...
           return view('profile.client.user_edit',['user'=>$User]); 
...
//////////////////////
          ...
          public function employers_add(){
             ...
             return view('profile.client.employers_add');
         }
  ...
  //dd($id);
          ...
          public function employers_edit($id){
            ...
            return view('profile.client.employers_edit',['user'=>$User]);
         }
