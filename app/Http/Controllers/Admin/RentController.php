...
//return view('admin.offers', ['offers' => $offers]); 
            ...
            return view('admin.rental_request', ['rents' => $rents]);        
        ...
        // }
         ...
         public function rental_request_add(Request $request){
    	    ...
    	    $token = $result['_token'];
             ...
             return view('admin.rental_request_add',['token'=>$token]);
         }
         ...
         public function submit(Request $req)
         {
            ...
            return redirect()->route('rental_request',$Rent->id);
...
//$date_from = $date_from[2]."-".$date_from[1]."-".$date_from[0];// [2].'-'.$date_from[1].'-'$date_from[0];
//echo date("d.m.Y", strtotime($date));

            
            
            //echo date("yyyy.mm.dd", strtotime());
            ...
            if($req->input('type_rent_date_from')!=''){
                ...
                //echo  $req->input('type_rent_date_from');
                $date_from = explode('/', $req->input('type_rent_date_from'));
                //print_r($date_from);
                //if(is_array($date_from))
                    $type_rent_date_from = date("Y.m.d", strtotime($date_from[2]."-".$date_from[1]."-".$date_from[0]));
                //echo $type_rent_date_from;
                //die;
 ...
 */
           ...
           return redirect()->route('rent_edit',$id);
...
*/            //dd($Offer);
            ...
            return view('admin.rental_request_edit', ['rent' => $rent]);     
        ...
        public function rent_delete_file(Request $request)
        {
         ...
         public function delete($id,$redirect=true)
         {
            ...
            DB::table('rents')->where('id', '=', $rent->id)->delete();
             ...
             if($redirect){
                return redirect()->route('rental_request');
             }            
